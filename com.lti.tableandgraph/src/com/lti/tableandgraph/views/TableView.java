...
import com.lti.charts.BarChartView;
...
//            "icons/unchecked.gif").createImage();
    ...
    public void createPartControl(Composite parent) {
       ...
       // searchLabel.setText("Search: ");
        ...
        /* add bargraph*/
        BarChartView bcv = new BarChartView();
        CategoryDataset dataset = bcv.createDataset();
        String title = "Bar Graph";
        JFreeChart barchart= bcv.createChart(dataset, title);
        ChartComposite cc =  new ChartComposite(parent, SWT.COLOR_BLUE, barchart); 
        form.getBody().setLayoutData(cc);
