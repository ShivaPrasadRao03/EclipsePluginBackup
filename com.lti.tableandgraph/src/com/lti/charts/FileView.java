...
public class FileView extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		/* Bar chart for defect timeline */
		
		CategoryDataset dataset3 = createDataset3();
		JFreeChart barChart1 = createChart2(dataset3, "Defect timeline");
		new ChartComposite(parent, SWT.COLOR_BLUE, barChart1); 
